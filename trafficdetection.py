...
def init_model():
    weights = 'C:\\Users\\User\\Traffic Capture\\models\\last.pt' # Path to the model weights
...
# Main function
def main():
    # Create a log file with the current date in the "traffic" folder
    current_date = time.strftime('%Y-%m-%d')
    log_directory = "traffic"  # Define the folder
    os.makedirs(log_directory, exist_ok=True)  # Ensure the folder exists
    log_file = os.path.join(log_directory, f"vehicles_{current_date}.txt")
    ...
    paths = [
        ...
        ["loc09","Hang Xanh","http://giaothong.hochiminhcity.gov.vn/render/ImageHandler.ashx?Id=5d9ddf49766c880017188ca0"],
        ["loc10","Highway A1 - Kha Van Can","http://giaothong.hochiminhcity.gov.vn/render/ImageHandler.ashx?id=58746314b807da0011e33cce&t=1667015860315"]
    ]
